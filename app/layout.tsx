...
export const metadata: Metadata = {
  ...
  description:
    "Exclusive gated community of twelve luxury cottages in Bhurban, Murree — five minutes from PC Bhurban, Kashmir peak views, 24/7 security, and direct booking.",
  keywords: [
    "luxury cottage Bhurban",
    "premium Murree vacation rental",
  ...
  openGraph: {
    ...
    title: "Swiss Cottages Six — Exclusivity above the clouds",
    description:
      "Twelve private cottages at 6,800 ft in Bhurban. Panoramic Pir Panjal views, manned gate, concierge booking.",
  },
  twitter: {
    card: "summary_large_image",
    title: "Swiss Cottages Six — Luxury cottage Bhurban",
    description: "Gated luxury cottages in Bhurban, Murree. Direct rates, no platform fees.",
  },
